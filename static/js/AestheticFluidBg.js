!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : e(
        ((t =
          "undefined" != typeof globalThis ? globalThis : t || self).Color4Bg =
          {})
      );
})(this, function (t) {
  "use strict";
                ...
                s.forEach(function (t) {
                  t.program.transparent
                    ...
                    0 === t.renderOrder &&
                      t.program.depthTest &&
                      i &&
                      (t.worldMatrix.getTranslation(X),
                      X.applyMatrix4(i.projectionViewMatrix),
                      (t.zDepth = X.z));
                }),
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t, e, i, r) {
              return t.length
                ? this.copy(t)
                : (Q(this._target, t, e, i, r), this.onChange(), this);
            },
          },
          {
            key: "rotateX",
          ...
          },
          {
            ...
            value: function (t, e) {
              return (
                e ? H(this._target, t, e) : H(this._target, this._target, t),
                this.onChange(),
                this
              );
            },
  ...
  var ht = (function (t) {
    function e() {
      ...
      return (
        r(this, e),
        l((t = i(this, e, [n, s, a, h, o, u, c, d, f, g, v, p, m, y, _, b])), t)
      );
    }
    return (
      o(e, t),
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ot.fromQuaternion(t),
                this._target.fromRotationMatrix(ot, e),
                i || this.onChange(),
                this
              );
            },
    ...
    gt = (function (t) {
      function e(t) {
        ...
        return (
          ...
          (n.projectionMatrix = new ht()),
          (n.viewMatrix = new ht()),
          (n.projectionViewMatrix = new ht()),
      ...
      return (
        ...
        s(e, [
          ...
          },
          {
            ...
            value: function (t) {
              return (
                t.applyMatrix4(ct.inverse(this.projectionMatrix)),
    ...
    yt = (function (t) {
      function e(t) {
        ...
        return (
          ...
          (n.frustumCulled = c),
          (n.renderOrder = f),
          (n.modelViewMatrix = new ht()),
          (n.normalMatrix = new pt()),
              ...
              if (
                ...
                if (
                  ...
                  this.generateMipmaps &&
                    ...
                    (bt(this.image.width) && bt(this.image.height))
        ...
        function t(e) {
          ...
          for (var D = [], O = 0; O < c; O++)
            this.textures.push(
              ...
              this.textures[O].update(),
              this.gl.framebufferTexture2D(
                this.target,
                this.gl.COLOR_ATTACHMENT0 + O,
                this.gl.TEXTURE_2D,
                this.textures[O].texture,
                0
              ),
              D.push(this.gl.COLOR_ATTACHMENT0 + O);
          D.length > 1 && this.gl.renderer.drawBuffers(D),
            (this.texture = this.textures[0]),
            m &&
            (this.gl.renderer.isWebgl2 ||
              this.gl.renderer.getExtension("WEBGL_depth_texture"))
              ? ((this.depthTexture = new Et(e, {
                  width: s,
                  height: h,
    ...
    Ft = (function (t) {
      function e(t) {
        ...
        return (
          ...
          Array.isArray(t)
            ? l(n, (n = i(this, e, d(t))))
            : l(n, (n = i(this, e, d(Tt.apply(Rt, arguments)))))
        );
      }
      return (
        o(e, t),
          ...
          },
          {
            ...
            value: function (t) {
              return Array.isArray(t)
                ? this.copy(t)
                : this.copy(Tt.apply(Rt, arguments));
            },
          },
          {
            key: "copy",
              ...
              var e =
                ...
                r =
                  arguments.length > 3 && void 0 !== arguments[3]
                    ? arguments[3]
                    : t;
              return t.length ? this.copy(t) : (V(this, t, e, i, r), this);
            },
          },
          {
            key: "copy",
  ...
  var zt = (function (t) {
    function e() {
      ...
      return (
        r(this, e),
        ((t = i(this, e, [n, 6])).name = "aesthetic-fluid"),
      ...
      s(e, [
        {
          ...
          value: function () {
            this.size =
              this.canvasW > this.canvasH ? this.canvasW : this.canvasH;
          },
        },
        {
          key: "_initRtt",
          value: function () {
            (this.rtt = new wt(this.gl, {
              width: 512,
              height: 512,
            })),
              (this.rttCamera = new gt(this.gl, {
                left: -0.5,
                right: 0.5,
                bottom: -0.5,
                top: 0.5,
              ...
              (this.rttProgram = new U(this.gl, {
                ...
                uniforms: {
                  ...
                  u_color_0: {
                    value: new Ft(this.palette[0]),
                  },
                  u_color_1: {
                    value: new Ft(this.palette[1]),
                  },
                  u_color_2: {
                    value: new Ft(this.palette[2]),
                  },
                  u_color_3: {
                    value: new Ft(this.palette[3]),
                  },
                  u_color_4: {
                    value: new Ft(this.palette[4]),
                  },
                  u_color_5: {
                    value: new Ft(this.palette[5]),
                  },
                  u_dye_0: {
                    value: new Nt(0.3, 0.8, 0.1, 0.7),
                  },
                  u_dye_1: {
                    value: new Nt(0.7, 0.8, 0.1, 0.7),
                  },
                  u_dye_2: {
                    value: new Nt(0.7, 0.2, 0.1, 0.7),
                  },
                  u_dye_3: {
                    value: new Nt(0.3, 0.2, 0.1, 0.7),
                  },
                  u_dye_4: {
                    value: new Nt(0.1, 0.5, 0.1, 0.45),
                  },
                  u_dye_5: {
                    value: new Nt(0.9, 0.5, 0.1, 0.45),
                  },
                },
              })),
        ...
        },
        {
          key: "_resetColors",
          value: function () {
            (this.rttProgram.uniforms.u_color_0.value = new Ft(
              this.palette[0]
            )),
              (this.rttProgram.uniforms.u_color_1.value = new Ft(
                this.palette[1]
              )),
              (this.rttProgram.uniforms.u_color_2.value = new Ft(
                this.palette[2]
              )),
              (this.rttProgram.uniforms.u_color_3.value = new Ft(
                this.palette[3]
              )),
              (this.rttProgram.uniforms.u_color_4.value = new Ft(
                this.palette[4]
              )),
              (this.rttProgram.uniforms.u_color_5.value = new Ft(
                this.palette[5]
              ));
          },
        },
